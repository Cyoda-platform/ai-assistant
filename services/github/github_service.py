...
class GitHubService:
    ...
    def resolve_repository_name(
        ...
        """Resolve repository name based on entity and language.
        ...
        Returns:
            Repository name
        """
        return resolve_repository_name(entity, programming_language)
    ...
    def resolve_repository_name_with_language(
        ...
        Returns:
            Repository name
        """
        return resolve_repository_name_with_language_param(entity, programming_language)
