...
class FlowProcessor:
    ...
    async def run_workflow(self, fsm, entity: AgenticFlowEntity, technical_id, current_state=None):
        ...
        entity.current_transition = event
        await _save_file(chat_id=technical_id, _data=json.dumps(entity, cls=ChatCompletionMessageEncoder), item="entity/chat.json")
        return current_state

    async def trigger_manual_transition(self, current_state, event, entity: AgenticFlowEntity, fsm, technical_id):
        """
