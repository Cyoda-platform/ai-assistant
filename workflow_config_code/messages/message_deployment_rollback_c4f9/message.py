"""
MessageDeploymentRollbackC4f9MessageConfig Message
...
class MessageDeploymentRollbackC4f9MessageConfig(MessageProcessor):
    """Message configuration for message_deployment_rollback_c4f9"""
    ...
    def get_name() -> str:
        ...
        return f"{MessageDeploymentRollbackC4f9MessageConfig.get_type()}.message_deployment_rollback_c4f9"
...
message_deployment_rollback_c4f9_message = MessageDeploymentRollbackC4f9MessageConfig()
