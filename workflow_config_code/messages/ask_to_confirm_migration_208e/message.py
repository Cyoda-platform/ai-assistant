"""
AskToConfirmMigration208eMessageConfig Message
...
class AskToConfirmMigration208eMessageConfig(MessageProcessor):
    """Message configuration for ask_to_confirm_migration_208e"""
    ...
    def get_name() -> str:
        ...
        return f"{AskToConfirmMigration208eMessageConfig.get_type()}.ask_to_confirm_migration_208e"
...
ask_to_confirm_migration_208e_message = AskToConfirmMigration208eMessageConfig()
