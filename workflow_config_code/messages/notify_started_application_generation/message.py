"""
NotifyStartedApplicationGenerationMessageConfig Message
...
class NotifyStartedApplicationGenerationMessageConfig(MessageProcessor):
    """Message configuration for notify_started_application_generation"""
    ...
    def get_name() -> str:
        ...
        return f"{NotifyStartedApplicationGenerationMessageConfig.get_type()}.notify_started_application_generation"
...
notify_started_application_generation_message = NotifyStartedApplicationGenerationMessageConfig()
