"""
NotifyEntitiesExtractedEde4MessageConfig Message
...
class NotifyEntitiesExtractedEde4MessageConfig(MessageProcessor):
    """Message configuration for notify_entities_extracted_ede4"""
    ...
    def get_name() -> str:
        ...
        return f"{NotifyEntitiesExtractedEde4MessageConfig.get_type()}.notify_entities_extracted_ede4"
...
notify_entities_extracted_ede4_message = NotifyEntitiesExtractedEde4MessageConfig()
