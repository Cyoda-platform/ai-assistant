"""
AskAboutApiD91fPyMessageConfig Message
...
class AskAboutApiD91fPyMessageConfig(MessageProcessor):
    """Message configuration for ask_about_api_d91f_py"""
    ...
    def get_name() -> str:
        ...
        return f"{AskAboutApiD91fPyMessageConfig.get_type()}.ask_about_api_d91f_py"
...
ask_about_api_d91f_py_message = AskAboutApiD91fPyMessageConfig()
