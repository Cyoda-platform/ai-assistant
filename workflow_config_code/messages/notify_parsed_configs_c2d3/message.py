"""
NotifyParsedConfigsC2d3MessageConfig Message
...
class NotifyParsedConfigsC2d3MessageConfig(MessageProcessor):
    """Message configuration for notify_parsed_configs_c2d3"""
    ...
    def get_name() -> str:
        ...
        return f"{NotifyParsedConfigsC2d3MessageConfig.get_type()}.notify_parsed_configs_c2d3"
...
notify_parsed_configs_c2d3_message = NotifyParsedConfigsC2d3MessageConfig()
