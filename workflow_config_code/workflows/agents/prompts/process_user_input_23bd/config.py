...
Generated from config: workflow_configs/agents/prompts/process_user_input_23bd/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """Have a dialogue with the user to understand their needs and requirements.
