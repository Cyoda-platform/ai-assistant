...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """You are tasked with fixing compilation errors for a specific Java file. You will receive the file path and have access to both the source file and the compilation output JSON.
