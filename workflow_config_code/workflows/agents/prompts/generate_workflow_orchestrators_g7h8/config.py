"""
GenerateWorkflowOrchestratorsG7h8PromptConfig Configuration

Generated from config: workflow_configs/agents/prompts/generate_workflow_orchestrators_g7h8/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """You are tasked with reading workflow JSON files from a directory and generating Java workflow orchestrators.
