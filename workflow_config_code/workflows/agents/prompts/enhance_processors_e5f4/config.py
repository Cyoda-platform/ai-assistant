...
Generated from config: workflow_configs/agents/prompts/enhance_processors_e5f4/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """You are Java 21 Spring Boot 3 developer. You are tasked with enhancing or fixing Cyoda processor {split_parameter_value} based on the compilation log and functional requirements.
