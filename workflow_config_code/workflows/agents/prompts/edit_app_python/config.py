"""
EditAppPythonPromptConfig Configuration

Prompt for editing existing Python applications.
Scans functional_requirements directory for editing requirements.
"""
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """# Cyoda Python Client Application Editing Guide
