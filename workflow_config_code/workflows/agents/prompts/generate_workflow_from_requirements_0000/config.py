...
Generated from config: workflow_configs/agents/prompts/generate_workflow_from_requirements_0000/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """For {split_parameter_value} entity find workflow design in the functional requirements. 
