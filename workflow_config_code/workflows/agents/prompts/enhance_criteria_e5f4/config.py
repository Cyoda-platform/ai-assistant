...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """You are Java 21 Spring Boot 3 developer. You are tasked with enhancing or fixing Cyoda criterion {split_parameter_value} based on the compilation log and functional requirements.
