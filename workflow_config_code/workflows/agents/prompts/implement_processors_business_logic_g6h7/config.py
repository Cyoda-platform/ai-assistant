...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """You are a senior Java developer tasked with IMPLEMENTING and ENHANCING processor and criteria classes to ensure they fully satisfy functional requirements and workflow specifications.
