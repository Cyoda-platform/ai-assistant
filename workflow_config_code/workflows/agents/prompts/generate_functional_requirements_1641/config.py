...
Generated from config: workflow_configs/agents/prompts/generate_functional_requirements_1641/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """Please return a well-formatted final version of the functional requirements confirmed by the user.
