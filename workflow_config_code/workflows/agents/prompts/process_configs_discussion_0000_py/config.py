"""
ProcessConfigsDiscussion0000PyPromptConfig Configuration

Generated from config: workflow_configs/agents/prompts/process_configs_discussion_0000_py/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """Please, adjust the functional requirements, entities and workflows and the API according to the user request. 
Use 'list_directory_files' tool to list all the files in the project. 
List all files in 'application/resources/workflow' to get the list of workflows.
...
Resource path for the workflows: 'application/resources/workflow/{entityname}/version_1/{EntityName}.json'
...
Functional requirements can be found in the file 'application/resources/functional_requirements/functional_requirement.md'.
