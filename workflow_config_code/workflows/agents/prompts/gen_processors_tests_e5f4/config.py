"""
GenProcessorsTestsE5f4PromptConfig Configuration
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """You are given a Gradle-based Java project with workflow “processors” that implement the interface:
