"""
PromptSent8926PromptConfig Configuration

Generated from config: workflow_configs/agents/prompts/prompt_sent_8926/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """MANDATORY TOOL USAGE - YOU MUST USE TOOLS:
