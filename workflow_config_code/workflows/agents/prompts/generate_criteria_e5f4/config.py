...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """You are Java 21 Spring Boot 3 developer. You are tasked with generating Cyoda criterion {split_parameter_value} based on the functional requirements and entity class files.
