...
Generated from config: workflow_configs/agents/prompts/generate_controller_d4e3/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """You are Java 21 Spring Boot 3 developer. You are tasked with generating an event-driven REST API controller for {split_parameter_value} entity only,  based on functional requirements. 
