"""
GenerateCriteriaFromWorkflowsB1ccPromptConfig Configuration

Generated from config: workflow_configs/agents/prompts/generate_criteria_from_workflows_b1cc/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """Generate Java criterion classes for workflow configurations that contain criteria of type 'function'.
