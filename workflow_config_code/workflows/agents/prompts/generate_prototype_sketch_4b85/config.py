"""
GeneratePrototypeSketch4b85PromptConfig Configuration

Generated from config: workflow_configs/agents/prompts/generate_prototype_sketch_4b85/message_0.md
...
def get_config() -> Callable[[Dict[str, Any]], str]:
    ...
    return lambda params=None: """## Task: Generate EntityControllerPrototype.java
