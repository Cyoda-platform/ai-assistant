...
Generated from config: workflow_configs/agents/configs/generate_criteria_from_workflows_42a6/agent.json
...
from workflow_config_code.workflows.agents.prompts.generate_criteria_from_workflows_b1cc.prompt import GenerateCriteriaFromWorkflowsB1ccPromptConfig
