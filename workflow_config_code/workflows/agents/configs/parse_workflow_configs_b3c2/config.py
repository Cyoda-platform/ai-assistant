...
Generated from config: workflow_configs/agents/configs/parse_workflow_configs_b3c2/agent.json
...
from workflow_config_code.workflows.agents.prompts.parse_workflow_configs_b3c2.prompt import ParseWorkflowConfigsB3c2PromptConfig
