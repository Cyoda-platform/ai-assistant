"""
ProcessUserInputE32dPyAgentConfig Configuration

Generated from config: workflow_configs/agents/configs/process_user_input_e32d_py/agent.json
...
from workflow_config_code.workflows.agents.tools.finish_discussion_782e.tool import FinishDiscussion782eToolConfig
...
from workflow_config_code.workflows.agents.prompts.process_user_input_a094_py.prompt import ProcessUserInputA094PyPromptConfig
...
def get_config() -> Callable[[Dict[str, Any]], Dict[str, Any]]:
    ...
    return lambda params=None: {
        ...
        "messages": [
                {
                        "role": "user",
                        "content_from_file": ProcessUserInputA094PyPromptConfig.get_name()
                }
        ],
        "tool_choice": "auto",
        "max_iteration": 30,
