...
Generated from config: workflow_configs/agents/configs/save_workflow_code_977a/agent.json
Configuration data for the agent.
"""

from typing import Any, Dict, Callable
from workflow_config_code.workflows.agents.prompts.save_workflow_code_959f.prompt import SaveWorkflowCode959fPromptConfig
