"""
ProcessUserInput5b2bAgentConfig Configuration

Generated from config: workflow_configs/agents/configs/process_user_input_5b2b/agent.json
...
from workflow_config_code.workflows.agents.tools.finish_discussion_2099.tool import FinishDiscussion2099ToolConfig
from workflow_config_code.workflows.agents.prompts.process_user_input_95f1.prompt import ProcessUserInput95f1PromptConfig
...
def get_config() -> Callable[[Dict[str, Any]], Dict[str, Any]]:
    ...
    return lambda params=None: {
        ...
        "tools": [
                ...
                {
                        "name": FinishDiscussion2099ToolConfig.get_tool_name()
                }
        ],
        "messages": [
                {
                        "role": "user",
                        "content_from_file": ProcessUserInput95f1PromptConfig.get_name()
                }
        ],
        "tool_choice": "auto",
        "max_iteration": 30,
