...
Generated from config: workflow_configs/agents/configs/process_user_input_57d2/agent.json
...
from workflow_config_code.workflows.agents.prompts.process_user_input_33bb.prompt import ProcessUserInput33bbPromptConfig
