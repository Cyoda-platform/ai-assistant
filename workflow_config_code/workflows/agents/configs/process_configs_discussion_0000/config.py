"""
ProcessConfigsDiscussion0000AgentConfig Configuration

Generated from config: workflow_configs/agents/configs/process_configs_discussion_0000/agent.json
...
from workflow_config_code.workflows.agents.tools.finish_config_discussion_0000.tool import FinishConfigDiscussion0000ToolConfig
from workflow_config_code.workflows.agents.prompts.process_configs_discussion_0000.prompt import ProcessConfigsDiscussion0000PromptConfig


def get_config() -> Callable[[Dict[str, Any]], Dict[str, Any]]:
    """Get agent configuration factory"""
    return lambda params=None: {
        "name": "process_configs_discussion_0000",
        "type": "agent",
        "publish": True,
        ...
        "tools": [
                ...
                {
                        "name": FinishConfigDiscussion0000ToolConfig.get_tool_name()
                }
        ],
        "messages": [
                {
                        "role": "user",
                        "content_from_file": ProcessConfigsDiscussion0000PromptConfig.get_name()
                }
        ],
        "tool_choice": "auto",
        "max_iteration": 30,
