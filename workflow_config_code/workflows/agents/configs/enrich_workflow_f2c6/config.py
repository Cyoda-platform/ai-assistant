...
Generated from config: workflow_configs/agents/configs/enrich_workflow_f2c6/agent.json
Configuration data for the agent.
"""

from typing import Any, Dict, Callable
from workflow_config_code.workflows.agents.prompts.enrich_workflow_9e00.prompt import EnrichWorkflow9e00PromptConfig
