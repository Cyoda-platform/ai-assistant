"""
ProcessUserInput57d2PyAgentConfig Configuration

Generated from config: workflow_configs/agents/configs/process_user_input_57d2_py/agent.json
...
from workflow_config_code.workflows.agents.tools.finish_discussion_8f05.tool import FinishDiscussion8f05ToolConfig
...
from workflow_config_code.workflows.agents.prompts.process_user_input_33bb_py.prompt import ProcessUserInput33bbPyPromptConfig
...
def get_config() -> Callable[[Dict[str, Any]], Dict[str, Any]]:
    ...
    return lambda params=None: {
        ...
        "messages": [
                {
                        "role": "user",
                        "content_from_file": ProcessUserInput33bbPyPromptConfig.get_name()
                }
        ],
        "tool_choice": "auto",
        "max_iteration": 30,
