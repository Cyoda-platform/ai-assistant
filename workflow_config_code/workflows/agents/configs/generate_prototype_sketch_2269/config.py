...
Generated from config: workflow_configs/agents/configs/generate_prototype_sketch_2269/agent.json
...
from workflow_config_code.workflows.agents.prompts.generate_prototype_sketch_4b85.prompt import GeneratePrototypeSketch4b85PromptConfig
