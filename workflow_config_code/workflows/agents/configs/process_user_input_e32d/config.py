...
Generated from config: workflow_configs/agents/configs/process_user_input_e32d/agent.json
...
from workflow_config_code.workflows.agents.prompts.process_user_input_a094.prompt import ProcessUserInputA094PromptConfig
