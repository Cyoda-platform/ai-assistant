...
Generated from config: workflow_configs/agents/configs/generate_workflow_from_requirements_0000/agent.json
...
from workflow_config_code.workflows.agents.prompts.generate_workflow_from_requirements_0000.prompt import GenerateWorkflowFromRequirements0000PromptConfig
