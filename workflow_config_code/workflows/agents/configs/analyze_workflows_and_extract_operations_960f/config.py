...
Generated from config: workflow_configs/agents/configs/analyze_workflows_and_extract_operations_960f/agent.json
Configuration data for the agent.
"""

from typing import Any, Dict, Callable
from workflow_config_code.workflows.agents.tools.add_application_resource_3968.tool import AddApplicationResource3968ToolConfig
from workflow_config_code.workflows.agents.prompts.analyze_workflows_and_extract_operations_f28d.prompt import AnalyzeWorkflowsAndExtractOperationsF28dPromptConfig
