...
Generated from config: workflow_configs/agents/tools/convert_workflow_to_dto_d870/tool.json
...
def get_config() -> Callable[[Dict[str, Any]], Dict[str, Any]]:
    ...
    return lambda params=None: {
        ...
        "function": {
                ...
                "parameters": {
                        "workflow_file_name": "src/main/resources/workflow/{EntityName}.json",
