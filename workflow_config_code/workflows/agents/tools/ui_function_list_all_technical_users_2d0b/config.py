"""
UiFunctionListAllTechnicalUsers2d0bToolConfig Configuration

Generated from config: workflow_configs/agents/tools/ui_function_list_all_technical_users_2d0b/tool.json
