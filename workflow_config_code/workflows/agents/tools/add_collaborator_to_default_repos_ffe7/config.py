"""
AddCollaboratorToDefaultReposFfe7ToolConfig Configuration

Generated from config: workflow_configs/agents/tools/add_collaborator_to_default_repos_ffe7/tool.json
