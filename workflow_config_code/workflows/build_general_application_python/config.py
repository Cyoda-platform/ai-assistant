...
from workflow_config_code.agents.define_functional_requirements_8ee2_py.agent import \
    DefineFunctionalRequirements8ee2PyAgentConfig
from workflow_config_code.agents.extract_entities_from_prototype_22c6_py.agent import \
...
from workflow_config_code.agents.generate_entities_requirements_accc_py.agent import \
...
from workflow_config_code.tools.init_chats_d512_py.tool import InitChatsD512PyToolConfig
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": InitChatsD512PyToolConfig.get_name(),
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 900000
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": GenerateEntitiesRequirementsAcccPyAgentConfig.get_name(),
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 900000
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": ExtractEntitiesFromPrototype22c6PyAgentConfig.get_name(),
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 900000
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": AskToDiscussConfigs0000PyMessageConfig.get_name(),
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 900000
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": ProcessConfigsDiscussion0000PyAgentConfig.get_name(),
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 900000
