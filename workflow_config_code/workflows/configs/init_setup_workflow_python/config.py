"""
InitSetupWorkflowPythonWorkflowConfig Configuration

Generated from config: workflow_configs/configs/init_setup_workflow_python.json
...
from workflow_config_code.workflows.agents.configs.prompt_sent_956f_py.agent import PromptSent956fPyAgentConfig
from workflow_config_code.workflows.agents.configs.process_user_input_e32d_py.agent import ProcessUserInputE32dPyAgentConfig
from workflow_config_code.workflows.agents.configs.prompt_sent_68db_py.agent import PromptSent68dbPyAgentConfig
...
from workflow_config_code.workflows.agents.configs.process_user_input_dd02_py.agent import ProcessUserInputDd02PyAgentConfig
from workflow_config_code.workflows.agents.configs.prompt_sent_a239_py.agent import PromptSentA239PyAgentConfig
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": "AgentProcessor.process_user_input_dd02_py",
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 300000,
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": "AgentProcessor.prompt_sent_a239_py",
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 300000,
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": "AgentProcessor.prompt_sent_68db_py",
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 300000,
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": "AgentProcessor.process_user_input_e32d_py",
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 300000,
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": "AgentProcessor.prompt_sent_956f_py",
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 300000,
