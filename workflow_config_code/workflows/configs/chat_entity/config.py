...
def get_config() -> Callable[[Dict[str, Any]], Dict[str, Any]]:
    ...
    return lambda params=None: {
        ...
        "states": {
                ...
                "locked_locked_submitted_workflow_question": {
                        "transitions": [
                                {
                                        "name": "unlock",
                                        "next": "locked_submitted_workflow_question",
                                ...
                                {
                                        "name": "fail_locked_locked_submitted_workflow_question",
                                        "next": "locked_locked_locked_submitted_workflow_question",
                                        "manual": False,
                                        "criterion": {
                                                "type": "group",
                                                "operator": "AND",
                ...
                "locked_locked_locked_submitted_workflow_question": {
                        "transitions": [
                                {
                                        "name": "unlock",
                                        "next": "locked_locked_submitted_workflow_question",
                                ...
                                {
                                        "name": "fail_locked_locked_locked_submitted_workflow_question",
                                        "next": "locked_locked_locked_locked_submitted_workflow_question",
                                        "manual": False,
                                        "criterion": {
                                                "type": "group",
                                                "operator": "AND",
                ...
                "locked_locked_locked_locked_submitted_workflow_question": {
                        "transitions": [
                                {
                                        "name": "unlock",
                                        "next": "locked_locked_locked_submitted_workflow_question",
                ...
                "locked_locked_processed_question": {
                        "transitions": [
                                {
                                        "name": "unlock",
                                        "next": "locked_processed_question",
                                ...
                                {
                                        "name": "fail_locked_locked_processed_question",
                                        "next": "locked_locked_locked_processed_question",
                                        "manual": False,
                                        "criterion": {
                                                "type": "group",
                                                "operator": "AND",
                ...
                "locked_locked_locked_processed_question": {
                        "transitions": [
                                {
                                        "name": "unlock",
                                        "next": "locked_locked_processed_question",
                                ...
                                {
                                        "name": "fail_locked_locked_locked_processed_question",
                                        "next": "locked_locked_locked_locked_processed_question",
                                        "manual": False,
                                        "criterion": {
                                                "type": "group",
                                                "operator": "AND",
                ...
                "locked_locked_locked_locked_processed_question": {
                        "transitions": [
                                {
                                        "name": "unlock",
                                        "next": "locked_locked_locked_processed_question",
                ...
                "locked_locked_locked_locked_chat": {
                        "transitions": [
                                ...
                                {
                                        "name": "fail_locked_locked_locked_locked_chat",
                                        "next": "locked_locked_locked_locked_locked_chat",
                                        "manual": False,
                                        "criterion": {
                                                "type": "group",
                                                "operator": "AND",
                ...
                "locked_locked_locked_locked_locked_chat": {
                        "transitions": [
                                {
                                        "name": "unlock",
                                        "next": "locked_locked_locked_locked_chat",
