"""
BuildGeneralApplicationJavaOptimizedWorkflowConfig Configuration
...
from workflow_config_code.workflows.agents.configs.generate_app_java.agent import GenerateAppJavaAgentConfig
...
from workflow_config_code.workflows.messages.notify_requirements_discussion_optimized.message import NotifyRequirementsDiscussionOptimizedMessageConfig
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": "MessageProcessor.notify_requirements_discussion_optimized",
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 900000,
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": "AgentProcessor.generate_app_java",
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
