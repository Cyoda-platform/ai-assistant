                        ...
                        "transitions": [
                                {
                                        ...
                                        "processors": [
                                                {
                                                        "name": NotifyRequirementsDiscussionOptimizedMessageConfig.get_name(),
                                                        "executionMode": "ASYNC_NEW_TX",
                                                        "config": {
                                                                "calculationNodesTags": "ai_assistant",
                                                                "responseTimeoutMs": 900000
                        ...
                        "transitions": [
                                {
                                        ...
                                        "processors": [
                                                {
                                                        "name": ProcessUserInput2c31OptimizedAgentConfig.get_name(),
                                                        "executionMode": "ASYNC_NEW_TX",
                                                        "config": {
                                                                "calculationNodesTags": "ai_assistant",
                                                                "responseTimeoutMs": 900000
                        ...
                        "transitions": [
                                {
                                        ...
                                        "processors": [
                                                {
                                                        "name": GenerateAppJavaAgentConfig.get_name(),
                                                        "executionMode": "ASYNC_NEW_TX",
                                                        "config": {
                                                                "calculationNodesTags": "ai_assistant",
