"""
EditGeneralApplicationJavaWorkflowConfig Configuration

Workflow for editing existing Java applications.
...
from workflow_config_code.workflows.agents.configs.edit_app_java.agent import EditAppJavaAgentConfig
...
from workflow_config_code.workflows.messages.notify_editing_requirements_discussion.message import NotifyEditingRequirementsDiscussionMessageConfig
...
ProcessorConfig = {
    ...
    "MessageProcessor.notify_editing_requirements_discussion": NotifyEditingRequirementsDiscussionMessageConfig,
    ...
    "AgentProcessor.edit_app_java": EditAppJavaAgentConfig,
