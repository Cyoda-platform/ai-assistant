...
Generated from config: workflow_configs/configs/edit_general_application_java.json
...
from workflow_config_code.workflows.agents.configs.process_user_input_2185.agent import ProcessUserInput2185AgentConfig
