"""
LockChat1135MessageConfig Message
...
class LockChat1135MessageConfig(MessageProcessor):
    """Message configuration for lock_chat_1135"""
    ...
    def get_name() -> str:
        ...
        return f"{LockChat1135MessageConfig.get_type()}.lock_chat_1135"
...
lock_chat_1135_message = LockChat1135MessageConfig()
