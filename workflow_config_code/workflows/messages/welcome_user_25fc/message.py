"""
WelcomeUser25fcMessageConfig Message
...
class WelcomeUser25fcMessageConfig(MessageProcessor):
    """Message configuration for welcome_user_25fc"""
    ...
    def get_name() -> str:
        ...
        return f"{WelcomeUser25fcMessageConfig.get_type()}.welcome_user_25fc"
...
welcome_user_25fc_message = WelcomeUser25fcMessageConfig()
