"""
NotifyDeploymentScheduledD873MessageConfig Message
...
class NotifyDeploymentScheduledD873MessageConfig(MessageProcessor):
    """Message configuration for notify_deployment_scheduled_d873"""
    ...
    def get_name() -> str:
        ...
        return f"{NotifyDeploymentScheduledD873MessageConfig.get_type()}.notify_deployment_scheduled_d873"
...
notify_deployment_scheduled_d873_message = NotifyDeploymentScheduledD873MessageConfig()
