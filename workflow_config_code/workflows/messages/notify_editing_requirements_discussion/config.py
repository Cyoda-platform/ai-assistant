"""
NotifyEditingRequirementsDiscussionMessageConfig Configuration

Message configuration for editing requirements discussion.
"""
...
We are working on **editing your existing application**.
...
2. Checkout your branch and add files to the branch directly to `src/main/resources/functional_requirements` directory. I will use them as reference.
