"""
WelcomeUserOptimizedMessageConfig Message
...
class WelcomeUserOptimizedMessageConfig(MessageProcessor):
    """Message configuration for welcome_user_optimized"""
    ...
    def get_name() -> str:
        ...
        return f"{WelcomeUserOptimizedMessageConfig.get_type()}.welcome_user_optimized"
...
welcome_user_optimized_message = WelcomeUserOptimizedMessageConfig()
