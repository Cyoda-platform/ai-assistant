"""
NotifyEditingRequirementsDiscussionPythonMessageConfig Message
...
class NotifyEditingRequirementsDiscussionPythonMessageConfig(MessageProcessor):
    """Message configuration for notify_editing_requirements_discussion_python"""
    ...
    def get_name() -> str:
        ...
        return f"{NotifyEditingRequirementsDiscussionPythonMessageConfig.get_type()}.notify_editing_requirements_discussion_python"
...
notify_editing_requirements_discussion_python_message = NotifyEditingRequirementsDiscussionPythonMessageConfig()
