"""
NotifyPrototypeGeneration0000MessageConfig Message
...
class NotifyPrototypeGeneration0000MessageConfig(MessageProcessor):
    """Message configuration for notify_prototype_generation_0000"""
    ...
    def get_name() -> str:
        ...
        return f"{NotifyPrototypeGeneration0000MessageConfig.get_type()}.notify_prototype_generation_0000"
