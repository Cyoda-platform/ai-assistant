"""
NotifyEditingCompleteMessageConfig Message
...
class NotifyEditingCompleteMessageConfig(MessageProcessor):
    """Message configuration for notify_editing_complete"""
    ...
    def get_name() -> str:
        ...
        return f"{NotifyEditingCompleteMessageConfig.get_type()}.notify_editing_complete"
...
notify_editing_complete_message = NotifyEditingCompleteMessageConfig()
