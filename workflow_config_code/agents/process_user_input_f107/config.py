...
from workflow_config_code.tools.edit_existing_app_design_additional_feature_e5a3.tool import EditExistingAppDesignAdditionalFeatureE5a3ToolConfig
...
from workflow_config_code.tools.add_new_workflow_a537.tool import AddNewWorkflowA537ToolConfig
from workflow_config_code.tools.edit_api_existing_app_29e6.tool import EditApiExistingApp29e6ToolConfig
from workflow_config_code.tools.edit_existing_workflow_fe13.tool import EditExistingWorkflowFe13ToolConfig
from workflow_config_code.tools.edit_existing_processors_3ed4.tool import EditExistingProcessors3ed4ToolConfig
from workflow_config_code.tools.get_cyoda_guidelines_f3bb.tool import GetCyodaGuidelinesF3bbToolConfig
from workflow_config_code.tools.finish_discussion_cd19.tool import FinishDiscussionCd19ToolConfig
...
from workflow_config_code.tools.ui_function_list_all_technical_users_7489.tool import UiFunctionListAllTechnicalUsers7489ToolConfig
from workflow_config_code.tools.ui_function_reset_client_secret_1cf5.tool import UiFunctionResetClientSecret1cf5ToolConfig
from workflow_config_code.prompts.process_user_input_f963.prompt import ProcessUserInputF963PromptConfig
...
def get_config() -> Callable[[Dict[str, Any]], Dict[str, Any]]:
    ...
    return lambda params=None: {
        ...
        "tools": [
                ...
                {
                        "name": EditExistingAppDesignAdditionalFeatureE5a3ToolConfig.get_tool_name()
                },
                {
                        "name": AddNewEntityForExistingAppCb15ToolConfig.get_tool_name()
                },
                {
                        "name": AddNewWorkflowA537ToolConfig.get_tool_name()
                },
                {
                        "name": EditApiExistingApp29e6ToolConfig.get_tool_name()
                },
                {
                        "name": EditExistingWorkflowFe13ToolConfig.get_tool_name()
                },
                {
                        "name": EditExistingProcessors3ed4ToolConfig.get_tool_name()
                },
                {
