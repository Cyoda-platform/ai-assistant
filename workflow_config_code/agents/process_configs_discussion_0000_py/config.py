...
from workflow_config_code.prompts.process_configs_discussion_0000_py.prompt import \
    ProcessConfigsDiscussion0000PyPromptConfig
...
from workflow_config_code.tools.finish_config_discussion_0000.tool import FinishConfigDiscussion0000ToolConfig
from workflow_config_code.prompts.process_configs_discussion_0000.prompt import ProcessConfigsDiscussion0000PromptConfig
...
def get_config() -> Callable[[Dict[str, Any]], Dict[str, Any]]:
    ...
    return lambda params=None: {
        ...
        "messages": [
            {
                "role": "user",
                "content_from_file": ProcessConfigsDiscussion0000PyPromptConfig.get_name()
            }
        ],
        "tool_choice": "auto",
        "max_iteration": 30,
