...
class GrpcStreamingFacadeFactory:
    ...
    @staticmethod
    def create(workflow_dispatcher, auth, chat_service, processor_loop, grpc_client=None) -> GrpcStreamingFacade:
        ...
        # Create and wire middleware chain
        logging_middleware = LoggingMiddleware()
        metrics_middleware = MetricsMiddleware()
        error_middleware = ErrorMiddleware()
        dispatch_middleware = DispatchMiddleware(
            router=router,
            builders=builders,
            outbox=outbox,
            services=services
        ...
        return GrpcStreamingFacade(
            ...
            builders=builders,
            outbox=outbox,
            first_middleware=logging_middleware,
