...
BRANCH_READY_NOTIFICATION = "🎉 **Your branch `{git_branch}` is ready!**\n\nI’ve added a GitHub branch in the repository where I’ll be posting updates. You can check it out now or come back to it anytime: 🔗 [Cyoda GitHub]({repository_url}/tree/{git_branch}) 👀 \n"
...
USER_ATTACHED_FILE_MESSAGE = "The user attached the full requirement in a file. You do not need the full requirement now."