...
class Config:
    ...
    MAX_IPS_PER_DEVICE_BEFORE_BLOCK: int = field(
        default_factory=lambda: _get_int_env("MAX_IPS_PER_DEVICE_BEFORE_BLOCK", default=300))
    MAX_IPS_PER_DEVICE_BEFORE_ALARM: int = field(
        default_factory=lambda: _get_int_env("MAX_IPS_PER_DEVICE_BEFORE_ALARM", default=100))
    ...
    def __post_init__(self):
        ...
        object.__setattr__(self, "DEPLOY_CYODA_ENV",
                           _get_env("DEPLOY_CYODA_ENV", default=f"https://{cm}/deploy/cyoda-env"))
        object.__setattr__(self, "DEPLOY_USER_APP",
                           _get_env("DEPLOY_USER_APP", default=f"https://{cm}/deploy/user-app"))
        object.__setattr__(self, "BUILD_USER_APP", _get_env("BUILD_USER_APP", default=f"https://{cm}/build/user-app"))
        object.__setattr__(self, "DEPLOY_CYODA_ENV_STATUS",
                           _get_env("DEPLOY_CYODA_ENV_STATUS", default=f"https://{cm}/deploy/cyoda-env/status"))
        object.__setattr__(self, "DEPLOY_USER_APP_STATUS",
                           _get_env("DEPLOYUSER_APP_STATUS", default=f"https://{cm}/deploy/user-app/status"))
