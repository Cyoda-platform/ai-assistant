...
class Config:
    def __init__(self) -> None:
        ...
        self.MAX_AI_AGENT_ITERATIONS    = _get_int_env("MAX_AI_AGENT_ITERATIONS", default=20)
        ...
        self.CLIENT_QUART_TEMPLATE_REPOSITORY_URL = _get_env(
        ...
        self.REPOSITORY_NAME = repo_name.removesuffix(".git")
