...
ENTITY_VERSION = os.getenv("ENTITY_VERSION", "1001")
CHAT_ID = os.getenv("CHAT_ID")
GRPC_PROCESSOR_TAG = os.getenv("GRPC_PROCESSOR_TAG", "ai_assistant")
...
DATA_REPOSITORY_URL = get_env("DATA_REPOSITORY_URL")
