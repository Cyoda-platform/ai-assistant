...
from workflow_config_code.agents.tools.trigger_parent_entity_b4c4.tool import TriggerParentEntityB4c4FunctionConfig
from workflow_config_code.workflows.functions.schedule_close_process_b2b5.function import ScheduleCloseProcessB2b5FunctionConfig
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": CheckScheduledEntityStatus4d37FunctionConfig.get_name(),
                ...
                "transitions": [
                    {
                        ...
                        "processors": [
                            {
                                "name": TriggerParentEntityB4c4FunctionConfig.get_name(),
                                "executionMode": "ASYNC_NEW_TX",
                                "config": {
                                    "calculationNodesTags": "ai_assistant",
                                    "responseTimeoutMs": 300000
