"""
EnhanceCriteriaE5f4PromptConfig Configuration

Configuration data for the enhance criteria prompt.
"""
...
You are Java 21 Spring Boot 3 developer. You are tasked with enhancing or fixing Cyoda criterion {split_parameter_value} based on the compilation log and functional requirements.

**ENHANCEMENT TASK:**
Review the existing criterion code and the compilation log to identify issues that need to be fixed or enhancements that need to be made according to the functional requirements.
...
2. **Analyze Compilation Issues**: Review compilation log for errors
...
2. **Implement Missing Validation Logic** from functional requirements
...
- Fix any compilation errors identified in the compilation log
- Enhance validation logic according to functional requirements

Output format:
CRITICAL: Return only the full criterion code. Do not include any other text or explanations.
"""
