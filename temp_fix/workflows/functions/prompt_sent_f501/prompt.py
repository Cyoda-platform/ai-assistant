"""
PromptSentF501PromptConfig Prompt
...
class PromptSentF501PromptConfig:
    """Prompt configuration for prompt_sent_f501"""

    @staticmethod
    def get_name() -> str:
        """Get the static name of this prompt"""
        return "prompt_sent_f501"
...
prompt_sent_f501_prompt = PromptSentF501PromptConfig()
